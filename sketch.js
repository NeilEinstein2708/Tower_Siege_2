...
function setup() {
  ...
  Engine.run(engine);
  ground = new Ground();
  stand1 = new Stand(590,300,300,10);
  stand2 = new Stand(900,200,250,10);
  ...
  //level one
  blocks1 = new Block(840,175,30,40);
  blocks2 = new Block(870,175,30,40);
  blocks3 = new Block(900,175,30,40);
  blocks4 = new Block(930,175,30,40);
  blocks5 = new Block(960,175,30,40);
  //level two
  blocks6 = new Block(870,135,30,40);
  blocks7 = new Block(900,135,30,40);
  blocks8 = new Block(930,135,30,40);
  //top
  blocks9 = new Block(900,95,30,40);
...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("Drag the polygon to destroy the blocks",500,30);
  textSize(12);
  text("Press Space to get a second Chance to Play!!",850 ,350);
  ground.display();
  stand1.display();
  stand2.display();
  strokeWeight(2);
